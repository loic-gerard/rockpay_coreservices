...
class TypeInterfacePaiementEntity extends Entity{

    const DEF_ATTRIBUTS = array(
        'pk_typeinterfacepaiement'          =>      'id',
        'tt_uid_typeinterfacepaiement'      =>      'uid',
        'tt_designation'      =>      'designation'

    );
    const DEF_ATTRIBUTS_APPEND = array();
    const DEF_ATTRIBUTS_ADDREQS = array('uid','designation');
    const DEF_ATTRIBUTS_UPDATEREQS = array();
    const DEF_ATTRIBUTS_READONLY = array();
    const DEF_ATTRIBUTS_IGNOREINOUTPUT = array();
    const DEF_TABLE = 'tb_typeinterfacepaiement';
